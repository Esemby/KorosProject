...
if (l_char == "a" || l_char == "あ")
{
    allow = 1;
    spec_m = "hello, fellow game tester~";
}
...
else if (l_char == "esemby" || l_char == "エせんび")
{
    allow = 1;
    ...
    if (global.language == "ja")
        ...
        spec_m = "Hello, hello, hello~";
}
else if (l_char == "robin" || l_char == "robinandnoxy")
{
    allow = 1;
    spec_m = "Koro, tell me what to put here";
}
...
{
    allow = 1;
    spec_m = scr_gettext("name_entry_confirm"); // Is this name correct?
}
